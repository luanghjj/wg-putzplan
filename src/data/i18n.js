export const T = {
  de: {
    ...
    // Anonymous reports
    reports:"Meldungen", newReport:"Anonym melden", sendReport:"Anonym senden",
    reportCategory:"Kategorie", reportText:"Beschreibung (anonym)",
    reportTarget:"Betroffene Person", reportAnon:"100% anonym — niemand sieht deinen Namen",
    reportAnonShort:"Anonym", reportAnonBanner:"Deine Identität bleibt geheim",
    reportNoOne:"Allgemein (kein Name)",
  ...
  vi: {
    ...
    // Anonymous reports
    reports:"Tố cáo", newReport:"Tố cáo ẩn danh", sendReport:"Gửi ẩn danh",
    reportCategory:"Loại vi phạm", reportText:"Mô tả sự việc (ẩn danh)",
    reportTarget:"Người vi phạm", reportAnon:"Danh tính của bạn được bảo mật hoàn toàn",
    reportAnonShort:"Ẩn danh", reportAnonBanner:"Tên bạn sẽ không được hiển thị",
    reportNoOne:"Chung (không chỉ đích danh)",
